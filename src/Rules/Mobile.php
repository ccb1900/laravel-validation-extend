...
class Mobile implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        //中国联通
        $uniform
            = '^((13[0-2])|(145)|(15[5-6])|(17[156])|(18[5,6])|(16[6]))\\d{8}|(170[4,7-9])\\d{7}$';
        //电信
        $telecom
            = '^((133)|(149)|(153)|(17[3,7])|(18[0,1,9])|(19[9]))\\d{8}|(170[0-2])\\d{7}$';


        return preg_match(sprintf('/%s/', $cmcc), $value)
            || preg_match(sprintf('/%s/', $uniform), $value)
            || preg_match(sprintf('/%s/', $telecom), $value);
    }
